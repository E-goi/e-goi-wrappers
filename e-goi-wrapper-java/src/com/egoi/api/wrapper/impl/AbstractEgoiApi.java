...
public abstract class AbstractEgoiApi implements EgoiApi {
    ...
    protected EgoiType walkMap(Map<String, Object> map) {
        EgoiType r = null;
        ...
        if (map.containsKey("key_0")) {
            ...
            for (String k : keys) {
                ...
                if (map.get(k) instanceof Map) {
                    mrl.add(walkValues(new EgoiMap((Map<String, Object>) map.get(k))));
                } else {
                    EgoiMap value = new EgoiMap();
                    value.put("value", map.get(k));
                    mrl.add(value);
                }
            }
    ...
    private EgoiType walkArray(List<Map<String, Object>> list) {
        EgoiMapList mrl = new EgoiMapList();
    ...
    protected EgoiMap walkValues(EgoiMap map) {
        for (String key : map.keySet()) {
            ...
            if (obj instanceof Map) {
                map.put(key, walkMap((Map<String, Object>) obj));
            }

            if (obj instanceof Object[]) {
                List<Map<String, Object>> value = extractMapList((Object[]) obj);
                map.put(key, walkArray(value));
            }
        }
    ...
    public <T extends EgoiType> T decodeResult(Object obj, Class<T> expected) throws EgoiException {
        ...
        if (obj instanceof String) {
            ...
            List<Map<String, Object>> mapList = extractMapList((Object[]) obj);
            r = walkArray(mapList);
        } else {
    ...
    private List<Map<String, Object>> extractMapList(Object[] arr) {
